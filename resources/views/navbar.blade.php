...
<ul class="navbar-list">
    ...
    <li class="nav-item dropdown custom-dropdown xyz">
        ...
        <div class="dropdown-menu main" aria-labelledby="programsSubDropdown">
            ...
            <a class="dropdown-item" href="https://sagecorps.com/how-it-works/health-and-safety/">Health and Safety</a>
    ...
    <li class="nav-item">
        <a class="navbar-link nlt" href="#elementor-action%3Aaction%3Dpopup%3Aopen%26settings%3DeyJpZCI6IjYzNDkiLCJ0b2dnbGUiOmZhbHNlfQ%3D%3D"><i style="font-size:16px" class="fa nt1">&#xf002;</i></a>
    </li>
    <li class="nav-item">
        <a class="btn btn-sm box-button navbar-link nlt" href="https://sagecorps.com/apply/" role="button" data-toggle="dropdown"
