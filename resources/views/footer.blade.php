<footer id="footer" class="footer-1">
    ...
    <div class="widget-title brandf"><a href="https://sagecorps.com/"><img style="margin: 40px; margin-top: 30px; margin-right: 63px;" width="160" height="48.66"
    ...
    <h5 class="widget-title">Company<span></span></h5>
    <ul class="thumbnail-widget">
        ...
        <li><a href="#" class="ftl1">Blog</a></li>
        <li><a href="https://sagecorps.com/contact/" class="ftl1">Contact Us</a></li>
    </ul>
    </div>
    </div>
    ...
    <h5 class="widget-title">Connect<span></span></h5>
                <div class="ftl3"><p>222 Merchandise Mart West, Suite 1212, Chicago, Illinois, 60654, United States</p>
      <div class="emailfield">
    <p>info@sagecorps.com</p>
    </div></div>
    </div>
...
<div class="container">
    <div class="row abc">
        <div class="col-sm-3 col-auto text-center ftl4 text-nowrap">
            <small style="color: #ffffff; font-size: 14px;">&#9400; Copyrights 2023 SAGE CORPS. ALL rights reserved</small>
        </div>
        <div class="col-md-3 col-auto"></div>
        <div class="col-md-3 col-auto"></div>
        <div class="col my-auto text-md-left text-right ftl4 text-nowrap">
            <small>
                <a href="https://sagecorps.com/privacy-policy/" class="p-t-c">Privacy policy</a>
                <a href="https://sagecorps.com/terms-conditions/" class="p-t-c">Terms & conditions</a>
            </small>
        </div>
    </div>
</div>
